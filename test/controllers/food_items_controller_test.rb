...
class FoodItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create food_item" do
    assert_difference('FoodItem.count') do
      post food_items_url, params: { food_item: { description: @food_item.description, image: @food_item.image, name: @food_item.name, price: @food_item.price } }
    end
  ...
  test "should update food_item" do
    patch food_item_url(@food_item), params: { food_item: { description: @food_item.description, image: @food_item.image, name: @food_item.name, price: @food_item.price } }
